/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc --env-interface=CloudflareEnv apps/worker/worker-configuration.d.ts` (hash: 5f0b5dc2c5c078dad3ac75dd787c8eed)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "DEMO_MODE" | "EVM_RPC_URL" | "CHAIN_ID" | "BLOCK_EXPLORER_URL" | "NETWORK_NAME" | "BLOCKCHAIN_PRIVATE_KEY" | "CONTRACT_ADDRESS">> {}
}
